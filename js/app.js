...
// ─── DEMO DATA ───────────────────────────────────────────────
const DEMO_CATALOG = [
  { id: 1, nombre: 'Suplemento Mineral FOS', categoria: 'ganado', precio: 15.50, precio_mayorista: 12.00, imagen: 'img/productos/organew-pet-suplemento-removebg-preview.png', descripcion: 'Suplemento mineral de alta concentración con FOS para bovinos.', etiquetas: ['ganado','suplemento','destacado'], disponible: true, destacado: true },
  { id: 2, nombre: 'Shampoo Antialergia Pet', categoria: 'mascotas', precio: 8.99, precio_mayorista: 7.00, imagen: 'img/productos/champu-pet-care.png-removebg-preview.png', descripcion: 'Fórmula dermatológica libre de parabenos para piel sensible.', etiquetas: ['mascotas','higiene'], disponible: true, destacado: false },
  { id: 3, nombre: 'Ivermectina Forte 3.5%', categoria: 'ganado', precio: 22.00, precio_mayorista: 18.00, imagen: 'img/productos/rich_0005s_0003_Prazoquntel-removebg-preview.png', descripcion: 'Antiparasitario de amplio espectro para bovinos, equinos y ovinos.', etiquetas: ['ganado','medicina','destacado'], disponible: true, destacado: true },
  { id: 4, nombre: 'Antipulgas Plus 4en1', categoria: 'mascotas', precio: 12.00, precio_mayorista: 9.50, imagen: 'img/productos/antipulgas-removebg-preview.png', descripcion: 'Elimina pulgas, garrapatas, piojos y ácaros en 24 horas.', etiquetas: ['mascotas','medicina'], disponible: true, destacado: false },
];
